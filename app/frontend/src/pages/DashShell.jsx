...
import { Activity, Bell, Bookmark, Bot, CalendarRange, Compass, FileText, GraduationCap, HandHeart, Layers, LayoutDashboard, Library, LineChart, ListChecks, Menu, MessagesSquare, NotebookPen, RotateCw, Search, Settings, Shield, ShoppingBag, Timer, Trophy, Users, XCircle, BookOpenCheck } from "lucide-react";
...
const SECTIONS = [
  ...
  { label: "Learning tools", items: [{ to: "/app/notes", label: "Notes", icon: NotebookPen, testId: "sidebar-notes" }, { to: "/app/flashcards", label: "Flashcards", icon: Layers, testId: "sidebar-flashcards" }, { to: "/app/study/mistakes", label: "Mistake book", icon: XCircle, testId: "sidebar-mistakes" }, { to: "/app/study/revision", label: "Revision calendar", icon: RotateCw, testId: "sidebar-revision" }, { to: "/app/reports", label: "Reports", icon: FileText, testId: "sidebar-reports" }] },
  { label: "People", items: [{ to: "/app/community", label: "Community", icon: MessagesSquare, testId: "sidebar-community" }, { to: "/app/groups", label: "Study groups", icon: Users, testId: "sidebar-groups" }, { to: "/app/partners", label: "Partner", icon: HandHeart, testId: "sidebar-partners" }, { to: "/app/mentors", label: "Mentors", icon: GraduationCap, testId: "sidebar-mentors" }, { to: "/app/resources", label: "Resources", icon: Library, testId: "sidebar-resources" }, { to: "/app/marketplace", label: "Marketplace", icon: ShoppingBag, testId: "sidebar-marketplace" }] },

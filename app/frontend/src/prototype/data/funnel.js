// Prototype mock data — onboarding funnel + analytics.
// Ported from docs/reference/UI_claude-code/data-funnel.jsx.
...
export const QUEUE_CTA_EXAMPLE = ["education", "grad_year", "state_domicile", "hours_per_day", "mock_cadence"];

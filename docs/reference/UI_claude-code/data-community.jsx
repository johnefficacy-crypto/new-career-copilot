/* Community data — spaces, channels, threads, users, groups, mentors, resources */
...
/* Spaces: one per canonical exam family + general */
const COMMUNITY_SPACES = [
  ...
  },
  {
    ...
    channels:[
      { id:"s-official", name:"official-updates", lockedAdminWrite:true, unread:1, lastActiveAt:"4h", pinned:1, members:18420 },
      { id:"s-form",     name:"form-help",                                  unread:22, lastActiveAt:"3m", pinned:1, members:11420 },
      { id:"s-prep",     name:"preparation",                                unread:11, lastActiveAt:"18m", pinned:2, members:14002 },
      { id:"s-pyq",      name:"pyq-discussion",                             unread:0,  lastActiveAt:"1h", pinned:1, members:9210 },
      { id:"s-cutoff",   name:"cutoffs-results",                            unread:0,  lastActiveAt:"6h", pinned:0, members:7820 },
    ],
  },
  {
    ...
    channels:[
      { id:"i-official", name:"official-updates", lockedAdminWrite:true, unread:0, lastActiveAt:"1d", pinned:1, members:9740 },
      { id:"i-form",     name:"form-help",                                  unread:3, lastActiveAt:"42m", pinned:0, members:5210 },
      { id:"i-prep",     name:"preparation",                                unread:6, lastActiveAt:"12m", pinned:1, members:7320 },
      { id:"i-pyq",      name:"pyq-discussion",                             unread:0, lastActiveAt:"5h", pinned:0, members:4108 },
      { id:"i-cutoff",   name:"cutoffs-results",                            unread:0, lastActiveAt:"2d", pinned:0, members:3220 },
    ],
  },
  {
    ...
    channels:[
      { id:"r-official", name:"official-updates", lockedAdminWrite:true, unread:0, lastActiveAt:"2d", pinned:1, members:4180 },
      { id:"r-form",     name:"form-help",                                  unread:1, lastActiveAt:"5h", pinned:0, members:2110 },
      { id:"r-prep",     name:"preparation",                                unread:0, lastActiveAt:"1h", pinned:0, members:3240 },
      { id:"r-pyq",      name:"pyq-discussion",                             unread:0, lastActiveAt:"3d", pinned:0, members:1880 },
      { id:"r-cutoff",   name:"cutoffs-results",                            unread:0, lastActiveAt:"1w", pinned:0, members:1410 },
    ],
  },
  {
...
const THREADS = {
  ...
  "u-prep": [
    ...
    { id:"t2", channelId:"u-prep", flair:"question",
      ...
      author:"u_aman", upvotes:208, downvotes:6, replies:64, createdAt:"7h",
      topReplies:[],
    },
    ...
    { id:"t4", channelId:"u-prep", flair:"mock-report",
      ...
      author:"u_anjali", upvotes:96, downvotes:3, replies:38, createdAt:"9h",
      topReplies:[],
    },
    { id:"t5", channelId:"u-prep", flair:"discussion",
      ...
      author:"u_aarav", upvotes:48, downvotes:11, replies:22, createdAt:"3h",
      topReplies:[],
    },
    { id:"t6", channelId:"u-prep", flair:"strategy",
      ...
      author:"u_neha", upvotes:340, downvotes:5, replies:51, createdAt:"2d",
      topReplies:[],
    },
  ],
  /* UPSC CSE · official */
  ...
  "u-form": [
    { id:"f1", channelId:"u-form", flair:"formhelp", pinned:true,
      ...
      author:"u_admin", upvotes:980, downvotes:0, replies:42, createdAt:"5d",
      topReplies:[],
    },
    { id:"f2", channelId:"u-form", flair:"question",
      ...
      author:"u_zaid", upvotes:34, downvotes:1, replies:9, createdAt:"38m",
      topReplies:[],
    },
    { id:"f3", channelId:"u-form", flair:"question",
      ...
      author:"u_pooja", upvotes:18, downvotes:2, replies:14, createdAt:"2h",
      topReplies:[],
    },
  ],
  /* UPSC · pyq */
  "u-pyq": [
    { id:"p1", channelId:"u-pyq", flair:"question", pinned:true,
      ...
      author:"u_kavya", upvotes:642, downvotes:6, replies:48, createdAt:"1d",
      topReplies:[],
      planRelevant:{ topic:"Polity · Federalism", reason:"Your weak topic" },
    },
    { id:"p2", channelId:"u-pyq", flair:"discussion",
      ...
      author:"u_aarav", upvotes:88, downvotes:1, replies:14, createdAt:"4h",
      topReplies:[],
    },
  ],
  /* SSC CGL · form-help */
  "s-form": [
    { id:"sf1", channelId:"s-form", flair:"formhelp", pinned:true,
      ...
      author:"u_admin", upvotes:520, downvotes:2, replies:30, createdAt:"3d",
      topReplies:[],
    },
    { id:"sf2", channelId:"s-form", flair:"question",
      ...
      author:"u_rohit", upvotes:38, downvotes:0, replies:21, createdAt:"12m",
      topReplies:[],
    },
  ],
  /* General · motivation */
  "g-motivation": [
    { id:"m1", channelId:"g-motivation", flair:"experience", pinned:true,
      ...
      author:"u_isha", upvotes:4218, downvotes:42, replies:312, createdAt:"5d",
      topReplies:[],
    },
    { id:"m2", channelId:"g-motivation", flair:"discussion",
      ...
      author:"u_anjali", upvotes:154, downvotes:6, replies:88, createdAt:"3h",
      topReplies:[],
    },
  ],
  /* General · groups */
  "g-groups": [
    { id:"gg1", channelId:"g-groups", flair:"discussion",
      ...
      author:"u_aarav", upvotes:62, downvotes:1, replies:24, createdAt:"6h",
      topReplies:[],
    },
  ],
  /* General · resources */
  "g-resources": [
    { id:"gr1", channelId:"g-resources", flair:"resource", pinned:true,
      ...
      author:"u_admin", upvotes:2840, downvotes:6, replies:42, createdAt:"2w",
      topReplies:[],
    },
  ],
};

/* Channel rules (per channel type) */
const CHANNEL_RULES = {
  official: [
...
/* Study room sessions (across groups) */
const STUDY_ROOM_SESSIONS = [
...
window.COMMUNITY_USERS = COMMUNITY_USERS;
window.COMMUNITY_SPACES = COMMUNITY_SPACES;
window.THREADS = THREADS;
window.FLAIRS = FLAIRS;
window.CHANNEL_RULES = CHANNEL_RULES;
window.STUDY_GROUPS = STUDY_GROUPS;
window.STUDY_ROOM_SESSIONS = STUDY_ROOM_SESSIONS;
window.ACCOUNTABILITY = ACCOUNTABILITY;
window.MENTORS = MENTORS;
window.MENTOR_SESSIONS = MENTOR_SESSIONS;
window.MENTOR_EARNINGS = MENTOR_EARNINGS;
window.RESOURCES = RESOURCES;
window.ADMIN_COMM = ADMIN_COMM;
